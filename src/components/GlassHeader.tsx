      ...
      <div className="container max-w-4xl mx-auto p-4 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <motion.button
            ...
            className="relative z-10 p-2 rounded-md text-sm font-semibold text-foreground/60 hover:text-foreground hover:bg-accent/50 transition-colors cursor-pointer"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            type="button"
          >
